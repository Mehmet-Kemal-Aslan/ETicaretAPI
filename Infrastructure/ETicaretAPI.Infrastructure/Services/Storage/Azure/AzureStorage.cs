...
namespace ETicaretAPI.Infrastructure.Services.Storage.Azure
{
    public class AzureStorage : Storage, IAzureStorage
    {
        ...
        public AzureStorage()
        {
            _connectionString = "DefaultEndpointsProtocol=https;AccountName=minieticaretprojesi;AccountKey=O30Oue2DrmoBKv1ZBgEFCFnsbczY77Lu7wSQM7sYIAgKJaJNbvYhe9h2RKG7F+2KTkUXSKJv+nNr+AStOGnJuQ==;EndpointSuffix=core.windows.net";
